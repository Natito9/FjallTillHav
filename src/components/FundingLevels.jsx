...
export default function FundingLevels() {
  return (
    <section
      className="relative h-auto px-4 py-15 md:p-17 flex justify-center md:justify-end items-center w-full"
      style={{
    ...
    >
      ...
      />
      <div className=" flex flex-col w-[90%] md:w-[50%] max-w-[900px] backdrop-blur-xs">
        ...
        <div className="flex flex-col md:flex-row md:flex-wrap justify-between items-left text-white ">
          ...
          <div className="mb-8 md:w-1/2">
            ...
            <p>
              + inbjudan som gäst i vår podcast &quot;ROOKIIS x&quot; samt
              förhandsvisning av dokumentären.
            </p>
          </div>
          <div className="mb-8 md:w-1/2">
            ...
            <p>
              + inbjudan till en exklusiv förhandsvisning av dokumentären i
              Stockholm.
            </p>
          </div>
        </div>
