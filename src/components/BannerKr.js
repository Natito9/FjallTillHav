export default function BannerKr() {
    return(
        <div className="flex flex-col justify-center items-center text-center bg-blue-50 text-black h-[40vh] p-4">
            <h2 className="text-3xl md:text-5xl font-extrabold mb-4">1KR = 1M </h2>
            <p className="text-text-base md:2xl p-3">1 krona = 1 meter löpning – varje steg tar oss närmare målet! 🌍🏔️</p>
