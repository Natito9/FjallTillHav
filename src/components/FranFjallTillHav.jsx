...
export default function FranfjallTillHav() {
  return (
    <section
      id="presentation"
      data-theme="dark"
      className="relative h-auto ]md:h-[90vh] px-4 py-15 md:p-17 flex justify-center md:justify-end items-center w-full flex-col-reverse md:flex-row "
      style={{
    ...
    >
      ...
      <div className="  text-white relative flex flex-col md:justify-start items-center w-[90%] md:w-[50%] max-w-[900px] ">
        <Image
          src="/assets/FFTHOttoProfile.jpg"
          alt="Otto Buckler"
          width={210}
          height={200}
          className="mb-1 w-44 mt-4"
          priority
        />

        <h3 className=" text-s uppercase pb-4">Otto Bücker - Föreläsare</h3>
        <p className="text-center w-1/2 ">
          “Vi sprang över 40mil - men det största vi hittade fanns inte på
          kartan. ”{" "}
        </p>
      </div>
   
      <div className=" text-white relative flex flex-col w-[90%] md:w-1/2 max-w-[900px] md:text-left bg- backdrop-blur-xs ">
